...
from ._check import check_coupling, check_numeric_array, check_option, check_snr_params
from .configuration import SourceConfiguration
from .coupling_graph import _set_coupling
from .snr import _adjust_snr_global, _adjust_snr_local
from .source_groups import PatchSourceGroup, PointSourceGroup
from .utils import _empty_dict_if_none
...
class SourceSimulator:
    ...
    def add_point_sources(
        ...
        location_params = _empty_dict_if_none(location_params)
        waveform_params = _empty_dict_if_none(waveform_params)
        snr_params = _empty_dict_if_none(snr_params)
