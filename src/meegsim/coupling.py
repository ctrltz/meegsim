...
def ppc_shifted_copy_with_noise(
    ...
    waveform and (2) mixing it with a specific amount of noise. This function only
    supports within-frequency coupling.
    ...
    Notes
    -----
    The desired value of coherence and phase lags are only on average across multiple
    simulations. For every individual output, coherence and phase lag might deviate
    from the desired values: The lower the requested coherence is, the higher is the
    variance of the output. For more information, see :doc:`this example
