...
def test_simulate_random_states():
    """
    This test assesses whether correct values of random state are used in
    the most low-level functions (location, waveform, coupling).
    ...
    print(source_seeds, coupling_seeds)
