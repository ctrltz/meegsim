...
cp docs/auto_examples/basics/images/thumb/sphx_glr_plot_brain_configuration_thumb.png $STATIC_THUMB
cp docs/auto_examples/basics/images/sphx_glr_plot_brain_configuration_001.png $STATIC_IMAGES
